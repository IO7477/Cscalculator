...
interface BigOHeaderProps {
  onBack?: () => void;
}

export function BigOHeader({ onBack }: BigOHeaderProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-xl font-bold text-gray-900 dark:text-white">Big O Calculator</h1>
            </div>
          </div>
